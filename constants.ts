...
// ==================== WIDGET VERSION ====================
export const WIDGET_VERSION = '2026.02.04.4'; // Format: YYYY.MM.DD.BUILD
// Previous: 2026.02.04.3 (added X button click listener for cleanup)
// Current: 2026.02.04.4 (auto-close reference panel when WordPress modal opens)
